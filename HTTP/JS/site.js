...
_PendingSendPortFinder: {"": "_MessageTraverser;ports,_visited",
  ...
  visitList$1: function(list) {
    ...
    $.forEach$1$a(list, new $._PendingSendPortFinder_visitList_closure(this));
  },
...
_Copier: {"": "_MessageTraverser;_visited",
  ...
  visitList$1: function(list) {
    var t1, copy, len, i;
    if (typeof list !== "object" || list === null || list.constructor !== Array && !$.isJsIndexable(list, list[$.dispatchPropertyName]))
...
_Copier_visitMap_closure: {"": "Closure;box_0,this_1",
  call$2: function(key, val) {
    var t1 = this.this_1;
    $.$indexSet$a(this.box_0.copy_0, t1._dispatch$1(key), t1._dispatch$1(val));
  }
},
...
makeLiteralMap: function(keyValuePairs) {
  ...
  iterator = $.get$iterator$a(keyValuePairs);
...
Maps_mapToString: function(m) {
  ...
  try {
    ...
    result.write$1("{");
    t1.first_0 = true;
    $.forEach$1$a(m, new $.Maps_mapToString_closure(t1, result));
    result.write$1("}");
  } finally {
...
LinkedHashMap: {"": "Object;_liblib$_length,_strings,_nums,_rest,_first,_last,_modifications",
  ...
  _newLinkedCell$2: function(key, value) {
    ...
    this._liblib$_length = $.$add$ns(this._liblib$_length, 1);
...
NoSuchMethodError: {"": "Error;_liblib0$_receiver,_memberName,_liblib0$_arguments,_namedArguments,_existingArgumentNames",
  toString$0: function(_) {
    ...
    if (t2 != null)
      $.forEach$1$a(t2, new $.NoSuchMethodError_toString_closure(t1));
...
["direction", "../DART/lib/direction.dart", , {
Direction: {"": "Object;value", static: {
...
Moon: {"": "Object;increment,random,left,top,size,direction,theMoon",
  ...
  MovingTheMoon$0: function() {
    ...
    switch (this.direction) {
      case C.Direction_0:
        this.top = $.$sub$n(this.top, this.increment);
        break;
      case C.Direction_1:
        t1 = this.increment;
        this.top = $.$sub$n(this.top, t1);
        this.left = $.$add$ns(this.left, t1);
        break;
      case C.Direction_2:
        this.left = $.$add$ns(this.left, this.increment);
        break;
      case C.Direction_3:
        t1 = this.increment;
        this.top = $.$add$ns(this.top, t1);
        this.left = $.$add$ns(this.left, t1);
        break;
      case C.Direction_4:
        this.top = $.$add$ns(this.top, this.increment);
        break;
      case C.Direction_5:
        t1 = this.increment;
        this.top = $.$add$ns(this.top, t1);
        this.left = $.$sub$n(this.left, t1);
        break;
      case C.Direction_6:
        this.left = $.$sub$n(this.left, this.increment);
        break;
      case C.Direction_7:
        t1 = this.increment;
        this.top = $.$sub$n(this.top, t1);
    ...
    $.set$top$x(this.theMoon.style, C.JSString_methods.$add($.toString$0(this.top), "%"));
    $.set$left$x(this.theMoon.style, C.JSString_methods.$add($.toString$0(this.left), "%"));
    t1 = new $._ZoneTimer($.get$_Zone__current(), new $.Moon_MovingTheMoon_closure(this), null);
    t2 = t1._zone;
    t2._openCallbacks = t2._openCallbacks + 1;
    t1._timer = $._createTimer(C.Duration_100000, t1.get$_run());
  },
  Moon$0: function() {
    this.left = Math.random() * 100 - 10;
    this.top = Math.random() * 100 - 10;
    this.size = Math.random() * 11 + 10;
    var t1 = this.random.nextInt$1(8);
    if (t1 < 0 || t1 >= 8)
      throw $.ioore(t1);
    this.direction = [C.Direction_0, C.Direction_1, C.Direction_2, C.Direction_3, C.Direction_4, C.Direction_5, C.Direction_6, C.Direction_7][t1];
    this.theMoon = document.getElementById("moon");
  },
  static: {
Moon$: function() {
  var t1 = new $.Moon(0.01, C.C__Random, null, null, null, null, null);
  t1.Moon$0();
  return t1;
}}
...
Moon_MovingTheMoon_closure: {"": "Closure;this_0",
  call$0: function() {
    this.this_0.MovingTheMoon$0();
  }
}}],
["site.dart", "../DART/site.dart", , {
main: function() {
  $.Moon$().ConstructingTheMoon$0();
  $.Stars$().GenerateStars$0();
}},
1],
["stars", "../DART/lib/stars.dart", , {
Stars: {"": "Object;numberStars,randomGen",
  GenerateStars$0: function() {
    var i, star, t1;
    for (i = 0; i < this.numberStars; ++i) {
      star = document.createElement("div");
      t1 = $.getInterceptor$x(star);
      t1.$$dom_setAttribute$2(star, "id", C.JSString_methods.$add("star-", C.JSInt_methods.toString$0(i)));
      t1.$$dom_setAttribute$2(star, "class", "star");
      this.SetStarSize$1(star);
      this.SetStarLocation$1(star);
      document.getElementById("stars").appendChild(star);
    }
    this.TwinkleStars$0();
  },
  SetStarSize$1: function(star) {
    var size, t1;
    size = Math.random() * 4 + 1;
    t1 = $.getInterceptor$x(star);
    $.set$width$x(t1.get$style(star), C.JSString_methods.$add(C.JSDouble_methods.toStringAsFixed$1(size, 2), "px"));
    $.set$height$x(t1.get$style(star), C.JSString_methods.$add(C.JSDouble_methods.toStringAsFixed$1(size, 2), "px"));
  },
  SetStarLocation$1: function(star) {
    var t1, t2, t3;
    t1 = Math.random();
    t2 = Math.random();
    t3 = $.getInterceptor$x(star);
    $.set$left$x(t3.get$style(star), C.JSString_methods.$add(C.JSDouble_methods.toStringAsFixed$1(t1 * 100, 2), "%"));
    $.set$top$x(t3.get$style(star), C.JSString_methods.$add(C.JSDouble_methods.toStringAsFixed$1(t2 * 100, 2), "%"));
  },
  TwinkleStars$0: function() {
    var star, t1, t2;
    star = document.getElementById(C.JSString_methods.$add("star-", C.JSInt_methods.toString$0(this.randomGen.nextInt$1(this.numberStars))));
    if (star != null) {
      star.setAttribute("class", "star twinkle");
      t1 = new $._ZoneTimer($.get$_Zone__current(), new $.Stars_TwinkleStars_closure(this, star), null);
      t2 = t1._zone;
      t2._openCallbacks = t2._openCallbacks + 1;
      t1._timer = $._createTimer(C.Duration_500000, t1.get$_run());
    }
    t1 = new $._ZoneTimer($.get$_Zone__current(), new $.Stars_TwinkleStars_closure0(this), null);
    t2 = t1._zone;
    t2._openCallbacks = t2._openCallbacks + 1;
    t1._timer = $._createTimer(C.Duration_250000, t1.get$_run());
  },
  Stars$0: function() {
    this.randomGen = C.C__Random;
    this.numberStars = this.randomGen.nextInt$1(101) + 100;
    this.GenerateStars$0();
  },
  static: {
Stars$: function() {
  var t1 = new $.Stars(null, null);
  t1.Stars$0();
  return t1;
}}
...
Stars_TwinkleStars_closure: {"": "Closure;this_0,star_1",
  call$0: function() {
    this.star_1.setAttribute("class", "star");
  }
},

Stars_TwinkleStars_closure0: {"": "Closure;this_2",
  call$0: function() {
    this.this_2.TwinkleStars$0();
  }
}}],
]);
...
C.Direction_0 = new $.Direction(0);
C.Direction_1 = new $.Direction(1);
C.Direction_2 = new $.Direction(2);
C.Direction_3 = new $.Direction(3);
C.Direction_4 = new $.Direction(4);
C.Direction_5 = new $.Direction(5);
C.Direction_6 = new $.Direction(6);
C.Direction_7 = new $.Direction(7);
